...
Como vemos, a excepción de "VR/Action camera" todas las muestras de tipo de cuerpo siguen una distribución normal debido a que su longitud es mayor de 30.
...
En este caso, ambas muestras presentan una distribución normal debido a que su longitud es mayor de 30.
...
A continuación se mostrarán las conclusiones extraídas a partir del análisis realizado:
* Las cámaras más caras son las SLR "grandes", que son las que se emplean profesionalmente. Las compactas, ultracompactas y cámaras de acción son las más asequibles.
* La aparición de dispositivos móviles con cámaras de calidad ha hecho desaparecer prácticamente por completo el segmento de las cámaras compactas y ultracompactas, manteniendose únicamente actualizadas el sector de las cámaras profesionales.
* No hay diferencia significativa entre la puntuación general recibida por cámaras Canon y Nikon
* Factores como tener GPS, tener un tipo de cuerpo "Large SLR" aumentan el precio final de la cámara.
* El precio afecta de forma negativa en la puntuación de la cámara final.
* La puntuación en la ergonomia o las características si que afectan de forma positiva en la puntuación general que recibirá la cámara. En cambio, la puntuación en la precisión de la cámara afecta de forma negativa en la puntuación final que esta tendrá.
* Podemos encontrar una correlación positiva entre la puntuación de las características y la puntuación del visor, entre el precio y la punutuación de ergonomía y manejo, y entre el precio y la puntuación de las características, cercana a 0.5 para todos los casos.
